  ...
  return (
    <Container>
      <ShareBox>
        ...
        <div>
          <button>
            <img src="/images/Photos-new-icon.png" alt="" />
            <span>Photo</span>
          </button>

          <button>
            <img src="/images/video-icon-image.png" alt="" />
            <span>Video</span>
          </button>

          <button>
            <img src="/images/events-icon-image.png" alt="" />
            <span>Events</span>
          </button>
      ...
      <div>
        <Article>
          ...
          <SocialActions>
            ...
            <button>
              <img src="/images/coomments-icon.svg" alt="" />
              <span>Comments</span>
            </button>
            <button>
              <img src="/images/share-icon-image.png" alt="" />
              <span>Share</span>
            </button>
            <button>
